            ...
            <div class="comment-meta">
                ...
                if ($comment->user_id) {
                    ...
                    if (!empty($comment_url)) {
                        $goto = str_replace('http://', '_', $comment_url);
                        $goto = str_replace('https://', '_', $goto);
                        //<span class="spanlink" onclick="GoTo('_yandex.ru/')"><span>яндекс</span></span>
                        echo '<cite class="comment-author spanlink js-link" itemprop="creator"' . $microformat_comment_url . ' target="_blank">' . get_comment_author($comment->user_id) . '</cite>';
                    } else {
