...
function contact_form_isif_life( $atts ){
    ...
    if(isset($_POST['submitted'])) {
        ...
        if ( ! empty( $_POST['contact_email'] ) ) {
            $commentError = 'Подозрительная активность - Вы робот?';
            $hasError = true;
        }
            ...
            <form action="<?php the_permalink(); ?>" method="post">
                ...
                <div class="contact_left">
                    ...
                    <div class="contact_email">
                        <input type="text" placeholder="E-mail" name="contact_email" id="contact_email" value="<?php if(isset($_POST['contact_email']))  echo $_POST['contact_email'];?>" class="required requiredField email" />
                        <input type="text" placeholder="E-mail" name="iimmaaiill" id="iimmaaiill" value="<?php if(isset($_POST['iimmaaiill']))  echo $_POST['iimmaaiill'];?>" class="required requiredField iimmaaiill" />
                        <?php if ( ! empty( $emailError ) ) { ?>
                            <div class="errors"><?=$emailError;?></div>
                        <?php } ?>
                    </div>
                    <div class="contact_theme">
                        <input type="text" placeholder="Тема сообщения" name="contact_theme" id="contact_theme" value="<?php if(isset($_POST['contact_theme'])) echo $_POST['contact_theme'];?>" class="required requiredField" />
