...
var version=$$$1.fn.jquery.split(' ')[0].split('.');var minMajor=1;var ltMajor=2;var minMinor=9;var minPatch=1;var maxMajor=4;if(version[0]<ltMajor&&version[1]<minMinor||version[0]===minMajor&&version[1]===minMinor&&version[2]<minPatch||version[0]>=maxMajor){throw new Error('Bootstrap\'s JavaScript requires at least jQuery v1.9.1 but less than v4.0.0');}})($);exports.Util=Util;exports.Alert=Alert;exports.Button=Button;exports.Carousel=Carousel;exports.Collapse=Collapse;exports.Dropdown=Dropdown;exports.Modal=Modal;exports.Popover=Popover;exports.Scrollspy=ScrollSpy;exports.Tab=Tab;exports.Tooltip=Tooltip;Object.defineProperty(exports,'__esModule',{value:true});})));!function(d,l){"use strict";var e=!1,o=!1;if(l.querySelector)if(d.addEventListener)e=!0;if(d.wp=d.wp||{},!d.wp.receiveEmbedMessage)if(d.wp.receiveEmbedMessage=function(e){var t=e.data;if(t)if(t.secret||t.message||t.value)if(!/[^a-zA-Z0-9]/.test(t.secret)){var r,a,i,s,n,o=l.querySelectorAll('iframe[data-secret="'+t.secret+'"]'),c=l.querySelectorAll('blockquote[data-secret="'+t.secret+'"]');for(r=0;r<c.length;r++)c[r].style.display="none";for(r=0;r<o.length;r++)if(a=o[r],e.source===a.contentWindow){if(a.removeAttribute("style"),"height"===t.message){if(1e3<(i=parseInt(t.value,10)))i=1e3;else if(~~i<200)i=200;a.height=i}if("link"===t.message)if(s=l.createElement("a"),n=l.createElement("a"),s.href=a.getAttribute("src"),n.href=t.value,n.host===s.host)if(l.activeElement===a)d.top.location.href=t.value}}},e)d.addEventListener("message",d.wp.receiveEmbedMessage,!1),l.addEventListener("DOMContentLoaded",t,!1),d.addEventListener("load",t,!1);function t(){if(!o){o=!0;var e,t,r,a,i=-1!==navigator.appVersion.indexOf("MSIE 10"),s=!!navigator.userAgent.match(/Trident.*rv:11\./),n=l.querySelectorAll("iframe.wp-embedded-content");for(t=0;t<n.length;t++){if(!(r=n[t]).getAttribute("data-secret"))a=Math.random().toString(36).substr(2,10),r.src+="#?secret="+a,r.setAttribute("data-secret",a);if(i||s)(e=r.cloneNode(!0)).removeAttribute("security"),r.parentNode.replaceChild(e,r)}}}}(window,document);
$(document).ready(function(){$('.carousel').carousel();carouselLazyLoad(1,true);});!function(a){"function"==typeof define&&define.amd?define(["jquery"],a):a("object"==typeof exports?require("jquery"):jQuery)}(function(a){var b,c=navigator.userAgent,d=/iphone/i.test(c),e=/chrome/i.test(c),f=/android/i.test(c);a.mask={definitions:{9:"[0-9]",a:"[A-Za-z]","*":"[A-Za-z0-9]"},autoclear:!0,dataName:"rawMaskFn",placeholder:"_"},a.fn.extend({caret:function(a,b){var c;if(0!==this.length&&!this.is(":hidden"))return"number"==typeof a?(b="number"==typeof b?b:a,this.each(function(){this.setSelectionRange?this.setSelectionRange(a,b):this.createTextRange&&(c=this.createTextRange(),c.collapse(!0),c.moveEnd("character",b),c.moveStart("character",a),c.select())})):(this[0].setSelectionRange?(a=this[0].selectionStart,b=this[0].selectionEnd):document.selection&&document.selection.createRange&&(c=document.selection.createRange(),a=0-c.duplicate().moveStart("character",-1e5),b=a+c.text.length),{begin:a,end:b})},unmask:function(){return this.trigger("unmask")},mask:function(c,g){var h,i,j,k,l,m,n,o;if(!c&&this.length>0){h=a(this[0]);var p=h.data(a.mask.dataName);return p?p():void 0}return g=a.extend({autoclear:a.mask.autoclear,placeholder:a.mask.placeholder,completed:null},g),i=a.mask.definitions,j=[],k=n=c.length,l=null,a.each(c.split(""),function(a,b){"?"==b?(n--,k=a):i[b]?(j.push(new RegExp(i[b])),null===l&&(l=j.length-1),k>a&&(m=j.length-1)):j.push(null)}),this.trigger("unmask").each(function(){function h(){if(g.completed){for(var a=l;m>=a;a++)if(j[a]&&C[a]===p(a))return;g.completed.call(B)}}function p(a){return g.placeholder.charAt(a<g.placeholder.length?a:0)}function q(a){for(;++a<n&&!j[a];);return a}function r(a){for(;--a>=0&&!j[a];);return a}function s(a,b){var c,d;if(!(0>a)){for(c=a,d=q(b);n>c;c++)if(j[c]){if(!(n>d&&j[c].test(C[d])))break;C[c]=C[d],C[d]=p(d),d=q(d)}z(),B.caret(Math.max(l,a))}}function t(a){var b,c,d,e;for(b=a,c=p(a);n>b;b++)if(j[b]){if(d=q(b),e=C[b],C[b]=c,!(n>d&&j[d].test(e)))break;c=e}}function u(){var a=B.val(),b=B.caret();if(o&&o.length&&o.length>a.length){for(A(!0);b.begin>0&&!j[b.begin-1];)b.begin--;if(0===b.begin)for(;b.begin<l&&!j[b.begin];)b.begin++;B.caret(b.begin,b.begin)}else{for(A(!0);b.begin<n&&!j[b.begin];)b.begin++;B.caret(b.begin,b.begin)}h()}function v(){A(),B.val()!=E&&B.change()}function w(a){if(!B.prop("readonly")){var b,c,e,f=a.which||a.keyCode;o=B.val(),8===f||46===f||d&&127===f?(b=B.caret(),c=b.begin,e=b.end,e-c===0&&(c=46!==f?r(c):e=q(c-1),e=46===f?q(e):e),y(c,e),s(c,e-1),a.preventDefault()):13===f?v.call(this,a):27===f&&(B.val(E),B.caret(0,A()),a.preventDefault())}}function x(b){if(!B.prop("readonly")){var c,d,e,g=b.which||b.keyCode,i=B.caret();if(!(b.ctrlKey||b.altKey||b.metaKey||32>g)&&g&&13!==g){if(i.end-i.begin!==0&&(y(i.begin,i.end),s(i.begin,i.end-1)),c=q(i.begin-1),n>c&&(d=String.fromCharCode(g),j[c].test(d))){if(t(c),C[c]=d,z(),e=q(c),f){var k=function(){a.proxy(a.fn.caret,B,e)()};setTimeout(k,0)}else B.caret(e);i.begin<=m&&h()}b.preventDefault()}}}function y(a,b){var c;for(c=a;b>c&&n>c;c++)j[c]&&(C[c]=p(c))}function z(){B.val(C.join(""))}function A(a){var b,c,d,e=B.val(),f=-1;for(b=0,d=0;n>b;b++)if(j[b]){for(C[b]=p(b);d++<e.length;)if(c=e.charAt(d-1),j[b].test(c)){C[b]=c,f=b;break}if(d>e.length){y(b+1,n);break}}else C[b]===e.charAt(d)&&d++,k>b&&(f=b);return a?z():k>f+1?g.autoclear||C.join("")===D?(B.val()&&B.val(""),y(0,n)):z():(z(),B.val(B.val().substring(0,f+1))),k?b:l}var B=a(this),C=a.map(c.split(""),function(a,b){return"?"!=a?i[a]?p(b):a:void 0}),D=C.join(""),E=B.val();B.data(a.mask.dataName,function(){return a.map(C,function(a,b){return j[b]&&a!=p(b)?a:null}).join("")}),B.one("unmask",function(){B.off(".mask").removeData(a.mask.dataName)}).on("focus.mask",function(){if(!B.prop("readonly")){clearTimeout(b);var a;E=B.val(),a=A(),b=setTimeout(function(){B.get(0)===document.activeElement&&(z(),a==c.replace("?","").length?B.caret(0,a):B.caret(a))},10)}}).on("blur.mask",v).on("keydown.mask",w).on("keypress.mask",x).on("input.mask paste.mask",function(){B.prop("readonly")||setTimeout(function(){var a=A(!0);B.caret(a),h()},0)}),e&&f&&B.off("input.mask").on("input.mask",u),A()})}})});jQuery(function($){$(".wpcf7-tel").mask("+7 (999) 999-9999");});
function carouselLazyLoad(numImg,numbersImg){if(numImg==null){numImg=1;}
if(numbersImg==null){numbersImg=false;}
var id;var version=detectIE();var imgJPG=$(".carousel.lazy picture");var multiSlider=$(".carousel.lazy");if(version||imgJPG.length==0){for(var i=0;i<multiSlider.length;i++){if(multiSlider.length==1){id=".carousel";}else{id="#"+$(multiSlider[i]).attr("id")+".carousel";}
lazySlider(numImg,id);lazySliderLast(id);if(numbersImg){numberImgSlider(0,id);}}
$('.carousel.lazy').on('slide.bs.carousel',function(ev){id="#"+$(this).attr("id")+".carousel";if(ev.direction=="right"){lazySliderLast(id);}else{lazySlider(1,id);}});if(numbersImg){$('.carousel.lazy').on('slid.bs.carousel',function(ev){id="#"+$(this).attr("id")+".carousel";var to;if(ev.to!=null){to=ev.to;}else{to=$(id+" .active").index();}
numberImgSlider(to,id);});}}else{for(var i=0;i<multiSlider.length;i++){if(multiSlider.length==1){id=".carousel";}else{id="#"+$(multiSlider[i]).attr("id")+".carousel";}
lazySliderSource(numImg,id);lazySliderSourceLast(id);if(numbersImg){numberImgSlider(0,id);}}
$('.carousel.lazy').on('slide.bs.carousel',function(ev){id="#"+$(this).attr("id")+".carousel";if(ev.direction=="right"){lazySliderSourceLast(id);}else{lazySliderSource(1,id);}});if(numbersImg){$('.carousel.lazy').on('slid.bs.carousel',function(ev){id="#"+$(this).attr("id")+".carousel";var to;if(ev.to!=null){to=ev.to;}else{to=$(id+" .active").index();}
numberImgSlider(to,id);});}}}
var numberImgSlider=function(to,id){var toSlider=to+1;var lengthSlider=$(id+".carousel img").length;if($(id+".carousel .numberSlider").length>0){$(id+".carousel .numberSlider > .sliderTo").text(toSlider);$(id+".carousel .numberSlider > .sliderLength").text(lengthSlider);}}
var lazySlider=function(numImg,id){var src;var imgs=$(id+'.lazy img.lazy-load');if(imgs.length>0){if(numImg>imgs.length){numImg=imgs.length;}
for(var i=0;i<numImg;i++){src=$(imgs[i]).attr("data-src");$(imgs[i]).attr("src",src);$(imgs[i]).removeAttr("data-src");$(imgs[i]).removeClass("lazy-load");}}}
var lazySliderLast=function(id){var src;var imgs=$(id+'.lazy img.lazy-load');if(imgs.length>0){var lastImg=imgs.length-1;for(var i=lastImg;i<imgs.length;i++){src=$(imgs[i]).attr("data-src");$(imgs[i]).attr("src",src);$(imgs[i]).removeAttr("data-src");$(imgs[i]).removeClass("lazy-load");}}}
var lazySliderSource=function(numImg,id){var imgs=$(id+".lazy picture > source[data-srcset]").parent();var dataSrcset="";var source="";if(imgs.length>0){if(numImg>imgs.length){numImg=imgs.length;}
for(var z=0;z<numImg;z++){source=$(imgs[z]).children("source");for(var i=0;i<source.length;i++){dataSrcset=$(source[i]).attr("data-srcset");$(source[i]).attr("srcset",dataSrcset);$(source[i]).removeAttr("data-srcset");}}}}
var lazySliderSourceLast=function(id){var imgs=$(id+".lazy picture > source[data-srcset]").parent();var dataSrcset="";var source="";if(imgs.length>0){var lastImg=imgs.length-1;for(var y=lastImg;y<imgs.length;y++){source=$(imgs[y]).children("source");for(var i=0;i<source.length;i++){dataSrcset=$(source[i]).attr("data-srcset");$(source[i]).attr("srcset",dataSrcset);$(source[i]).removeAttr("data-srcset");}}}}
