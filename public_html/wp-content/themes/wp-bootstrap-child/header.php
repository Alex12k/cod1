...
<head>
	...
	<meta name="mailru-domain" content="ca3kJFVBUvhwcbdB" />
...
<?php $menu_bs_style = 'navbar-dark bg-dark';?>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header <?php if ( get_theme_mod( 'sticky_header', 0 ) ) : echo 'sticky-top'; endif; ?>">
		<nav id="site-navigation" class="main-navigation navbar navbar-expand-lg custom-scroll <?=$menu_bs_style?>">
			...
			new Modal_v2('Написать нам', do_shortcode('[contact-form-7 id="714" title="Контактная форма 1"]'));
			...
			<div class="copyright">
				<small>
					© 2020 Официальный сайт компании <br> BLACK HORSE ABSOLUT <br> 
					Дизайн-проекты интерьеров. Эксклюзивная отделка жилых помещений премиум-класса
				</small>		
			</div>
