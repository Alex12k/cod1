...
class ftpcrawler
{
     ...
     */
    public function rawlist($path, $depth = 0)
    {
                ...
                foreach($buffer as $line)
                {
                    ...
                    $info = array(
                        ...
                        "date" => date("D, d M Y H:i:s", 
                                    mktime($hour, $minute, 0, $this->months[$parts[5]], $parts[6], $year)), 
                        "name" => $parts[8],
                        "path" => $path . "/" . $parts[8],
    ...
    public function crawl($format = null)
    {
        ...
        switch(strtolower($format))
        {
            ...
            case "html":
                $output = "<table border='1'><tr><td>" . implode($headers, "</td><td>") . "</td>\r\n";
...
$themeFtpPath = 'alff.ru/public_html/wp-content/themes/omw2.0b-2';
$folder	  = $themeFtpPath.'/omw';

$ftpcrawler->server = "ftp://$user:$pass@$host:21/$folder/";
...
//print_arr($ftpcrawler->crawl('html'));
	
//print_arr($ftpcrawler);
