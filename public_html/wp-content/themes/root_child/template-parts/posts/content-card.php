...
$thumb 			= get_the_post_thumbnail($post->ID, 'thumb-wide', array('itemprop'=>'image'));

/* --- БЛОК ПРОВЕРОК-- */

/* Нужна ли entry-meta */
if('post' === get_post_type() && ($is_show_category || $is_show_comments || $is_show_views ) ){		
		$entryMetaTrue = true;
	}
				   ...
				   <?php
                    ...
                    <span class="entry-meta__info">
                        <?php if ( $is_show_comments ) { ?>
							<span class="entry-meta__comments" title="<?php _e( 'Comments', 'root' ) ?>">
                        ...
                        <?php if ( $is_show_views ) { 
								if ( function_exists('the_views') ) { ?>
										<span class="entry-meta__views" title="<?php _e( 'Views', 'root' ) ?>">
